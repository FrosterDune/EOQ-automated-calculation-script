...
df = pd.read_csv(filepath_or_buffer="quantity_template.csv", encoding="UTF-8", delimiter=",")

class Qopt:

    def calculations_qopt(self, order_quantity, ordering_cost, unit_price, holding_cost, unit_cost, period,
                          num_of_days=360):
...
if __name__ == "__main__":
    qopt = Qopt()
    print(qopt.calculations_qopt(4000, 1200, 300, 0.2, 1, 1))
    qopt.save()
